  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Detail Data Order Dokumen </h5>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <input type="text" value="{{$orders->jumlah_halaman}}" class="form-control" readonly>
                  </div>           
                </div>
                <div class="col-md-6">
                  <div class="form-group">
...
<div class="modal fade" id="editDokumen{{$edit->id_order}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('edit-order-dokumen', $edit->id_order)}}" method="post">
          {{ csrf_field() }}
          @method('PUT')
          <input type="text" name="id_order" value="{{ old('id_order') }}" hidden></td>
          <div class="form-group">
          ...
          <div class="form-group">
            <input type="number" name="jumlah_halaman" value="{{$edit->jumlah_halaman}}" hidden></td>
            <label for="jumlah_halaman" class="col-form-label">Jumlah Halaman Dokumen</label>
            <input type="number" class="form-control" id="jumlah_halaman" name="jumlah_halaman" value="{{$edit->jumlah_halaman}}">
          </div>
          <div class="form-group">
            ...
            <div class="modal-body">
              {{ csrf_field() }}
              <div class="form-group">
                <h6 for="path_file"> * Dokumen Anda = {{$edit->path_file}}</h6>
                <br>
                <input type="file" name="path_file" required="required" value="{{$edit->path_file}}">
              </div>
            </div>
          </div>
          <div class="modal-footer">
            ...
            <tbody id="myTable">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a type="button" class="update" title="Update" data-toggle="modal" data-target="#editDokumen{{$orders->id_order}}"><i class="far fa-edit material-icons text-green"></i></a><p class="font-weight-bold text-green">Edit</p>
                  <a href="#" class="delete" title="Delete" order_dk="{{$orders->id_order}}"><i class="fas fa-trash-alt material-icons text-red"></i></a><p class="font-weight-bold text-red">Hapus</p>
                </td>
              </tr>
              @endforeach
            </tbody>
...
<script>
  $('.delete').click(function(){
    var order_dk = $(this).attr('order_dk')
    Swal.fire({
      ...
      if (result.isConfirmed) {
        window.location = "/det-order-dokumen/"+order_dk+"/delete";  
        Swal.fire(
          'Berhasil!',
