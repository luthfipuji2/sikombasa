...
@section('title', 'Detail Order Subtitle')
@section('container')
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Detail Data Order Subtitle </h5>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <a href="/download-sub-klien/{{$orders->id_order}}" class="btn btn-success btn-sm" ><i class="fas fa-download"></i> Download Video</a>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    @if(!empty($orders->revisi->path_file_revisi))
                      ...
                      <a href="/download-sub-revisi/{{$orders->id_order}}" class="btn btn-success btn-sm" ><i class="fas fa-download"></i> Download Video</a>
                    @else (empty($orders->revisi->path_file_revisi))
                      <label>Video Pengerjaan Dari Translator</label>
                      <a href="/download-sub-translator/{{$orders->id_order}}" class="btn btn-success btn-sm" ><i class="fas fa-download"></i> Download Video</a>
                    @endif
                  </div>           
                </div>
              </div>
...
<div class="modal fade" id="editSubtitle{{$edit->id_order}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('edit-order-subtitle', $edit->id_order)}}" method="post">
          @csrf
          @method('PUT')
            ...
            <tbody id="myTable">
              ...
              <tr>
                ...
                <td>
                  ...
                  <a type="button" class="update" title="Update" data-toggle="modal" data-target="#editSubtitle{{$orders->id_order}}"><i class="far fa-edit material-icons text-green"></i></a><p class="font-weight-bold text-green">Edit</p>
                  <a href="#" class="delete" title="Delete" order_st="{{$orders->id_order}}"><i class="fas fa-trash-alt material-icons text-red"></i></a><p class="font-weight-bold text-red">Hapus</p>
                </td>
              </tr>
              @endforeach
            </tbody>
