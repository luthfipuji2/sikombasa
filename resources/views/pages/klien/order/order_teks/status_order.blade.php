                ...
                @foreach ($status as $stat)
                    <tr>
                        ...
                        <td scope="row" class="text-center">
                            ...
                            @elseif(!empty($stat->text_trans) && ($stat->parameterjenislayanan->p_jenis_layanan == "Premium") && empty($stat->revisi->id_revisi) && ($stat->status_at == "selesai") || !empty($stat->review->id_review))
                            <a type="button" class="detail" title="Detail Order" data-toggle="modal" data-target="#detailModal{{$stat->id_order}}">Detail</a>
                            @elseif(!empty($stat->text_trans) && ($stat->parameterjenislayanan->p_jenis_layanan == "Premium") && !empty($stat->revisi->id_revisi) && ($stat->status_at == "selesai") || !empty($stat->revisi->text_revisi) || !empty($stat->review->id_review))
                            <a type="button" class="detail" title="Detail Order" data-toggle="modal" data-target="#detailModal{{$stat->id_order}}">Detail</a>
                            @elseif(!empty($stat->text_trans) && ($stat->parameterjenislayanan->p_jenis_layanan == "Basic") && ($stat->status_at == "selesai") || !empty($stat->review->id_review))
                            <a type="button" class="detail" title="Detail Order" data-toggle="modal" data-target="#detailModal{{$stat->id_order}}">Detail</a>
                            @endif
                        </td>
                    </tr>
