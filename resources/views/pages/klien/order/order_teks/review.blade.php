...
@section('title','Review Order Teks')
@section('content')
...
<div class="modal fade" id="tambahModal{{$rev->id_order}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{route('tambah_review_teks', $rev->id_order)}}" method="POST" enctype="multipart/form-data">
      {{ csrf_field() }}
      {{ method_field('PUT') }}
                  ...
                  @if(empty($rev->review->id_review) && empty($rev->review->id_order) || !empty($rev->review->id_review))
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <tr>
                            <td><p class="font-weight-bold">Jenis Teks</p><td>
                            <td><p class="font-weight"> {{$rev->parameterjenisteks->p_jenis_teks}} </p></td>
                        </tr>
                        <tr>
