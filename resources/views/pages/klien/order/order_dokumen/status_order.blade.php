...
@section('title','Status Order Dokumen')
@section('content')
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$stat->jumlah_halaman}}" class="form-control" readonly>
                    </div>           
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                    <label for="path_file" class="col-sm-3 col-form-label">Download Dokumen Klien</label>
                    <a href="/download-dokumen-klien/{{$stat->id_order}}" class="btn btn-success btn-sm" ><i class="fas fa-download"></i> Download Dokumen</a>
                </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
...
<div class="modal fade" id="perbaikanModal{{$stat->id_order}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" value="{{$stat->id_order}}" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Revisi Order Dokumen </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="{{route('revisi_order_dokumen', $stat->id_order)}}" method="post">
      {{ csrf_field() }}
      {{ method_field('PUT') }}
        <div class="modal-body">
        <!-- Main content -->
...
<div class="modal fade" id="finishModal{{$stat->id_order}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <form action="{{route('finish_order_dokumen', $stat->id_order)}}" method="post">
      {{ csrf_field() }}
      {{ method_field('PUT') }}
        <div class="modal-body">
        <!-- Main content -->
