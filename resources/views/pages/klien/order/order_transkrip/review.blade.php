...
@section('content')
 ...
 <!-- Modal Tambah -->
@foreach($review as $w)
<div class="modal fade" id="tambah{{$w->id_order}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="review">
                    @foreach($review as $d)
                    @if(!empty($d->durasi_audio) && ($d->id_review == NULL))
                    <div class="card">
                      ...
                      <div class="card-body">
                        <table width="250px">
                          ...
                          <tr>
                            <td><p class="font-weight-bold">Durasi Audio</p><td>
                            <td><p class="font-weight">{{(($d->order->durasi_audio/60)%60)}} Menit</p></td>
                          </tr>
                        </table>
                  ...
                  <div class="tab-pane" id="riwayat">
                    ...
                    @if(!empty($r->id_review) && ($r->durasi_audio))
                    <div class="card">
                      <div class="card-header">
                      ...
                      <div class="card-body">
                        <table>
                          ...
                          <tr>
                            <td><p class="font-weight-bold">Nama File </p><td>
                            <td><p class="font-weight">: {{$r->nama_dokumen}}</p></td>
                          </tr>
                          @endif
                          @if($r->rating=='2')
                          <tr>
