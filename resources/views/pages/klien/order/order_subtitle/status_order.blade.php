...
@section('title','Status Order Subtitle')
@section('content')
            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <a href="/download-subtitle-klien/{{$stat->id_order}}" class="btn btn-success btn-sm" ><i class="fas fa-download"></i> Download Video</a>
                </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <a href="/download-subtitle-revisi/{{$stat->id_order}}" class="btn btn-success btn-sm" ><i class="fas fa-download"></i> Download Dokumen</a>
                      @elseif (empty($stat->revisi->path_file_revisi) && !empty($stat->path_file_trans))
                      <label>Dokumen Pengerjaan Dari Translator</label>
                      <a href="/download-subtitle-translator/{{$stat->id_order}}" class="btn btn-success btn-sm" ><i class="fas fa-download"></i> Download Dokumen</a>
                      @elseif (empty($stat->revisi->path_file_revisi) && empty($stat->path_file_trans))
                      <label>Dokumen Pengerjaan Dari Translator</label>
...
<div class="modal fade" id="perbaikanModal{{$stat->id_order}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" value="{{$stat->id_order}}" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Revisi Order Subtitle </h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="{{route('revisi_order_subtitle', $stat->id_order)}}" method="post">
      {{ csrf_field() }}
      {{ method_field('PUT') }}
        <div class="modal-body">
        <!-- Main content -->
...
<div class="modal fade" id="finishModal{{$stat->id_order}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <form action="{{route('finish_order_subtitle', $stat->id_order)}}" method="post">
      {{ csrf_field() }}
      {{ method_field('PUT') }}
        <div class="modal-body">
        <!-- Main content -->
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                      ...
                      <a href="/download-subtitle-revisi/{{$stat->id_order}}" class="btn btn-success btn-sm" ><i class="fas fa-download"></i> Download Video</a>
                      @else (empty($stat->revisi->path_file_revisi))
                      <label>Video Pengerjaan Dari Translator</label>
                      <a href="/download-subtitle-translator/{{$stat->id_order}}" class="btn btn-success btn-sm" ><i class="fas fa-download"></i> Download Video</a>
                      @endif
                  </div>           
                </div>
                <!--/.col (left) -->
